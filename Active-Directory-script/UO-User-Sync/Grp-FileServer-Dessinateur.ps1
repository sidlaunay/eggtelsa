# AddUsersToGroup.ps1
$OU = "OU=Dessinateur,OU=Users,OU=EGGTELSA,DC=eggtelsa,DC=net"
$Group = "CN=Grp-FileServer-Dessinateur,OU=Grp-FileServer,OU=Groups,OU=EGGTELSA,DC=eggtelsa,DC=net"
